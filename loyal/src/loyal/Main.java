...
public class Main extends javax.swing.JFrame {
    ...
    this.uname = username;    // Assign the username to the instance variable
    jLabel4.setText(uname);   // Set the username label after assignment
    
    this.usertype = utype;    // Assign the user type to the instance variable
    jLabel5.setText(usertype); // Set the user type label after assignment
    
    this.newid = id;          // Assign the ID to the instance variable  
    ...
    private void initComponents() {
        ...
        jButton10.setText("View Prescription");
